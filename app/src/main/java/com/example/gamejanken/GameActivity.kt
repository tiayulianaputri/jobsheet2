...
class GameActivity :AppCompatActivity(){
    ...
    private lateinit var computerImageViews: ImageView
    ...
    private fun initComponents(){
        computerImageViews = findViewById(R.id.computerImageView)
    ...
    private fun startGame(option: String) {
        ...
        computerImageViews.setImageResource(Game.pickDrawable(computerOption))
